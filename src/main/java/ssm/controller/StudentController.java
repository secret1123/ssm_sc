...
public class StudentController extends BaseController {
    ...
    @RequestMapping("queryCoursesByStudentId/{id}")
        private String queryCoursesByStudentId(@PathVariable int id){
            session.setAttribute("student",studentService.query("queryCoursesByStudentId",id));
            return "redirect:/student/courses.jsp";
        }
}